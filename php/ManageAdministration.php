            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="ManageAdministration.php" aria-expanded="false"><i class="mdi mdi-group"></i><span class="hide-menu">Manage Administration</span></a></li>
                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Manage Administration</li>
                            </ol>
                        </nav>
                        <h1 class="mb-0 fw-bold">Manage Administration</h1>
                    </div>
