                ...
                <div class="page-breadcrumb">
                    <div class="row align-items-center">
                        <div class="col-6">
                            ...
                            <h1 class="mb-0 fw-bold">Manage Teachers</h1>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover align-middle text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $rs = Database::search("SELECT * From `teacher` WHERE `status_id`='2'");
                                                $n = $rs->num_rows;
                                                for ($y = 0; $y < $n; $y++) {
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="">
                                                                <h4 class="m-b-0 font-16"><?php echo $teacher["id"] ?></h4>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <label class="badge bg-danger" onclick='teacherinvite(<?php echo $teacher["id"] ?>)'>Ivite</label>
                                                        </td>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-md-flex">
                                        <div>
                                            <h4 class="card-title">Teachers for a subject</h4>
                                            ...
                                            <tbody>
                                                <div class="col-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-select" id="teacher1">
                                                            ...
                                                            for ($x = 0; $x < $n; $x++) {
                                                                $grade = $rs->fetch_assoc();
                                                            ?>
                                                                <option value="<?php echo $grade["id"] ?>"> <?php echo $grade["full_name"] ?></option>
                                                        ...
                                                        <div class="col-2 d-grid">
                                                            <button class="btn btn-info" onclick="addSubjectTeacher();">Add</button>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-md-flex">
                                        <div>
                                            <h4 class="card-title">Teachers for a grade</h4>
                                        ...
                                        <table class="table mb-0 table-hover align-middle text-nowrap">
                                            ...
                                            <div class="col-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2 d-grid">
                                                        <button class="btn btn-info" onclick="addGradeTeacher();">Add</button>
                                                    </div>
                                                </div>
