                        ...
                        <div class="col-6">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 d-flex align-items-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">results check </li>
                                </ol>
                            </nav>
                            <h1 class="mb-0 fw-bold">Results Check</h1>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="dl mb-5">
                                        ...
                                        <select class="form-select shadow-none">
                                            <option value="0" selected>Select exam /assigment</option>
                                        </select>
                                        </br>
                                        <select class="form-select shadow-none">
                                    ...
                                    <div class="col-4 d-grid">
                                                ...
                                                <button class="btn btn-info" onclick="resultCheck();">Search</button>
