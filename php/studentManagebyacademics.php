                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="teacherManage.php" aria-expanded="false"><i class="mdi mdi-face"></i><span class="hide-menu">Teachers</span></a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover align-middle text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $rs1 = Database::search("SELECT * From `academic_has_grade` WHERE `academic_id`='" . $_SESSION["academic"]["id"] . "'");
                                                $z = $rs1->num_rows;
                                                if ($z == 1) {
                                                    $gradeid = $rs1->fetch_assoc();

                                                    $rs = Database::search("SELECT * From `student` WHERE `status_id`='2' AND `grade_id`='" . $gradeid["grade_id"] . "' ");
                                                    $n = $rs->num_rows;
                                                    for ($y = 0; $y < $n; $y++) {
                                                ...
                                                ?>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="">
                                                                    <h4 class="m-b-0 font-16"><?php echo $student["id"] ?></h4>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <label class="badge bg-danger" onclick='studentinvite(<?php echo $student["id"] ?>)'>Ivite</label>
                                                            </td>
