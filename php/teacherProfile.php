                            ...
                            <div class="card">
                                <div class="card-body">
                                    <center class="m-t-30"> <img src="../assets/images/users/5.jpg" class="rounded-circle" width="150" />
                                        ...
                                        <h6 class="card-subtitle"> <?php echo $_SESSION["teacher"]["full_name"] ?></h6>
                                ...
                                <div class="card-body"> <small class="text-muted">Email address </small>
                                    <h6><?php echo $_SESSION["teacher"]["full_name"] ?></h6>
                                    <small class="text-muted p-t-30 db">Phone</small>
                                    <h6><?php echo $_SESSION["teacher"]["phone"] ?></h6>
                                    ...
                                    for ($x = 0; $x < $n; $x++) {
                                        $id = $rs->fetch_assoc();
                                        $rs1 = Database::search("SELECT * FROM `subject` WHERE `id` ='" . $id["subject_id"] . "'");
                                        $name = $rs1->fetch_assoc();
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-material mx-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" placeholder="Your name" id="name" readonly value="<?php echo $_SESSION["teacher"]["full_name"] ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email" class="col-md-12">Email</label>
                                            <div class="col-md-12">
                                                <input type="email" placeholder="email@admin.com" id="email" class="form-control form-control-line" readonly value="<?php echo $_SESSION["teacher"]["email"] ?>" id="example-email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Password</label>
                                            <div class="col-md-12">
                                                <input type="password" placeholder="password" id="password" readonly value="<?php echo $_SESSION["teacher"]["password"] ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Phone No</label>
                                            <div class="col-md-12">
                                                <input type="text" placeholder="123 456 7890" class="form-control form-control-line" id="phone" value="<?php echo $_SESSION["teacher"]["phone"] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Address</label>
                                            <div class="col-md-12">
                                                <textarea rows="5" class="form-control form-control-line" id="address"><?php echo $_SESSION["teacher"]["address"] ?></textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-success text-white" onclick="updateTeacherProfile();">Update Profile</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
